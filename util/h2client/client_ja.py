    ...
    *,
    ...
    if scheme in {"socks", "socks4", "socks5"}:
        try:
            ...
            raise OSError("SOCKS proxy requires PySocks") from exc
    ...
    if scheme == "https":
        raise OSError("HTTPS proxy is not supported by the JA/H2 transport")
